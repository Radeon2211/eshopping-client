...
const createStore = (isFormLoading: boolean, formError: string) => {
...
const setUp = (props: PropsWithChildren<FormProps>, store: MockStoreEnhanced<unknown, object>) => {
  return {
    ...renderAppPart(
...
describe('<Form />', () => {
  describe('check how renders', () => {
    ...
    it('should render submit button without cancel button', () => {
      const props: PropsWithChildren<FormProps> = {
        ...defaultProps,
        headingText: '',
        cancellable: false,
        btnColor: 'red',

...
export default function AddProduct() {
  ...
  const onAddProduct = useCallback(
    (creds: AddProductForm, currentPath: string) =>
      dispatch(actions.addProduct(creds, currentPath)),
    [dispatch],
  );
        ...
        >
          <Input
            ...
            config={{
              ...
              autoComplete: 'off',
              autoFocus: true,
              onInput: setFieldTouched.bind(AddProduct, 'name', true, true),
          ...
          <SideBySide $proportion="1/1">
            <Input
              ...
              config={{
                ...
                max: 1000000,
                step: '.01',
                onInput: setFieldTouched.bind(AddProduct, 'price', true, true),
            ...
            <Input
              ...
              config={{
                ...
                min: 1,
                max: 1000000,
                onInput: setFieldTouched.bind(AddProduct, 'quantity', true, true),
          ...
          <Input
            ...
            config={{
              ...
              onInput: setFieldTouched.bind(AddProduct, 'description', true, true),
              maxRows: 6,
